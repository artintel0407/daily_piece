const pieces = [
  ...
  },
  {
    ...
    note:
      "처음에는 인간형 존재를 중심으로 이미지를 만들었지만, 손과 인체 표현이 계속 신경 쓰였다. 그래서 존재 자체를 사물과 공간으로 바꾸었고, 오히려 Daily Pieces의 방향성과 더 잘 맞는 결과가 나왔다. 앞으로는 인간형보다 사물, 공간, 구조, 상징 중심의 이미지를 더 활용하기로 했다."
  },
  {
    id: 3,
    day: 2,
